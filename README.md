...
| V&V | `docs/vv/` | Verification & validation plan + report (119 tests, RMSE ~1e-14) |
...
**Complete — full S1–S15 reverse chain, all- ADFs, original round-trip V&V; 119 tests, CI green.**
