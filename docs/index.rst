...
model, and the **real operational GIPP** (per-pixel dark + relative response) — nothing is
fitted or synthetic.

It serves two purposes: realistic **L0 RAW generation** when true Sentinel-2 L0 is
unavailable, and an original radiometric **round-trip V&V** on real L1A data with the real
